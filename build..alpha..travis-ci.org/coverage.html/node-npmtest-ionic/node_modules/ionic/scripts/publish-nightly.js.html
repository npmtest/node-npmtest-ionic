...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">94.87% <small>(37 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >    console.log(`Something went wrong with publishing the nightly. This process modifies the package.json, so restore it before committing code! - ${ex.message}`);</span>
